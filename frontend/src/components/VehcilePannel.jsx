...
}} className='flex items-center border-2 active:border-black  mb-2 rounded-xl w-full p-3 justify-between'>
...
<div className='ml-2 w-1/2'>
  <h4 className='font-medium text-base'>UberGo <span>
